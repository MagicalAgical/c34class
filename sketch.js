...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   blower.position(210,320);
   blower.size(110,110);
   blower.mouseClicked(airblow);
  
 
   rope = new Rope(7,{x:115,y:90});
   rope2 = new Rope(7,{x:425,y:90});
  ...
  star = createSprite(300,80)
  star.scale = 0.02

  star.addImage(star_img);

  star2 = createSprite(50,300)
  star2.addImage(star_img);
  star2.scale = 0.02


  stars = createSprite(50,35)
  stars.addAnimation('empty',emptystars)
  stars.addAnimation('onestar',onestar)
  stars.addAnimation('fullstar',fullstars)
  stars.scale = 0.2
...
function draw() 
{
  ...
  if(collide(fruit,star2,20) == true){
    star2.visible = false;
    stars.changeAnimation('fullstar')
  }
